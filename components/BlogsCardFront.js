...
const BlogsCardFront = ({ post }) => {
  const { handle, title, excert, category, image } = post;

  return (
    <div
      key={title}
      className="flex flex-col p-4 shadow-lg overflow-hidden sm:p-6 child bg-white"
    >
